...
optuna_journal_log_fwfm = f"{tmp_save_dir}/optuna-journal_fwfm.log"
optuna_journal_log_lr_fwfm = f"{tmp_save_dir}/optuna-journal_lr_fwfm.log"
optuna_journal_log_pruned_fwfm = f"{tmp_save_dir}/optuna_journal_log_pruned_fwfm.log"
