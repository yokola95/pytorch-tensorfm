...
def get_model(name, dataset, rank_param, emb_size, dim_int = [2,3], ten_ranks = [2,2]):
    """
    ...
    # For an index 1 <= i <= l, we consider a d_i-order interaction of rank r_i
        ...
        return TensorFactorizationMachineModel(num_features, num_columns, emb_size, dim_int=dim_int, rank_tensors=ten_ranks, is_multivalued=is_multival)
    elif name == 'fnn':
